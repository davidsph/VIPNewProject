...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
       ...
       positionName.backgroundColor=[UIColor clearColor];
        ...
        companyAddress=[[UILabel alloc]initWithFrame:CGRectMake(200, 35, 50, 25)];
        companyAddress.font=[UIFont fontWithName:@"Arial" size:12.0];
         companyAddress.backgroundColor=[UIColor clearColor];
