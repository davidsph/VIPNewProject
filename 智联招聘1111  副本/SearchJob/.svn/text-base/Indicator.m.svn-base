...
{
    UIImageView *indicatorImage = [[UIImageView alloc]initWithImage:[[UIImage imageNamed:@"QQ20121016-1.png"] stretchableImageWithLeftCapWidth:10 topCapHeight:10]];
    ...
    indicatorImage.layer.opacity = 0.7;
